...
include( 'ajc.flash-sales.php' ); // flash sales 
include( 'ajc.aftership.php' ); // aftership integration
...
add_action( 'mandrill_payload', function( $message ) {
	$message['template']['content'][] = array(
	    'name' => 'products',
	    'content' => 'Dynamic!'
	);
	$message['template']['name'] = 'AJC 2';
	return $message;
});

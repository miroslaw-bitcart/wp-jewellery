...
define( 'AJC_PRICE_TAX', 'price_range' );
...
add_action( 'init', function() {
	...
	if( !term_exists( 'all_picks', AJC_OLLY_TAX ) ) {
		wp_insert_term(
			'All picks', // the term 
			AJC_OLLY_TAX, // the taxonomy
			array(
				'description' => 'All picks',
				'slug' => 'all_picks'
			)
		);
	}

	foreach( array( '0_250', '250_500', '500_1000', '1000_2000', '2000_3000', '3000_5000', '5000_10000' ) as $range ) {

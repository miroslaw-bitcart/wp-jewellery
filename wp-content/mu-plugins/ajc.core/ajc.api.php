    ...
    <div class="modal-body product">
		...
		<div class="product-description right">
			...
			<?php if( $ajc_product->is_available() ) : ?>
				<ul id="cart-buttons">
					<li>
						<a href="<?php echo get_permalink($pid); ?>" class="silver button left">Full Details<span class="ion-chevron-right"></span></a>
					</li> 
			 		<li>
			 			<button type="submit" class="black left"><?php echo apply_filters('single_add_to_cart_text', __('Add to Bag', 'woocommerce'), $product->product_type); ?><span class="ion-bag"></span></button>
			 		</li>
			 	</ul>
			<?php endif; ?>

			...
			if ( $totals = $order->get_order_item_totals() ) {
				...
				foreach ( $totals as $total ) {
					...
					?><tr>
						...
						<td style="text-align:left; border: 1px solid #eee; font-weight:normal; font-family:georgia,serif; <?php if ( $i == 1 ) echo 'border-top-width: 4px;'; ?>"><?php echo $total['value']; ?></td>
					</tr><?php
				}
			}
		?>

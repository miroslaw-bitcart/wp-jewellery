		...
		<div class="product modal">
			...
			<div class="clearfix border-bottom">
				<div class="image"><?php echo get_the_post_thumbnail( $product->get_id(), ( 'product-x-small' ) ); ?></div>
				<div class="headings">
					<h1 itemprop="name"><?php echo $product->get_title(); ?></h1>
					<h3 class="left"><?php echo $product->get_period(); ?></h3>
					<h3 class="left sku"><em>№</em> <?php echo $product->get_sku(); ?></h3>
					<h3 itemprop="left price" class="left"><?php echo $product->get_price_html(); ?></h3>
				</div>
			</div>
			...
			<div class="right-col">
				...
				<form action="" method="POST" id="ajc_enquiry_form" class="modal-form clearfix">
					...
					<button type="submit" class="medium silver button">Send Enquiry</button>
				</form>

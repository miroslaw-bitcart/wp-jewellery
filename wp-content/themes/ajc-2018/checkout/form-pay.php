...
<div class="content checkout">
	...
	<form id="order_review" method="post">
		...
		<div id="payment" class="padded">
			...
			<div class="place-order clearfix" style="padding-top: 2em;">
				<?php $woocommerce->nonce_field('pay')?>
				<input type="submit" class="green button left" id="place_order" value="<?php _e( 'Place Order', 'woocommerce' ); ?>" />

							...
							echo '
								<tr class="' . esc_attr( apply_filters('woocommerce_checkout_table_item_class', 'checkout_table_item', $values, $cart_item_key ) ) . '">
									<td class="product-name">' .
										$_product->get_image( 'product-x-small' ) .
										apply_filters( 'woocommerce_checkout_product_title', $_product->get_title(), $_product ) . ' ' .
										apply_filters( 'woocommerce_checkout_product_title', $_product->get_sku(), $_product ) . ' ' .
									'</td>
	...
	<div id="payment" class="clearfix">
		...
		<div class="form-row place-order">
			...
			<p class="form-row terms">
				<label for="terms" class="checkbox">I have read &amp; accept the <a href="<?php echo esc_url( get_permalink(woocommerce_get_page_id('terms')) ); ?>" target="_blank"><?php _e( 'Terms &amp; Conditions', 'woocommerce' ); ?></a></label>
				<input type="checkbox" class="left input-checkbox small-space-right small-space-above" name="terms" <?php checked( isset( $_POST['terms'] ), true ); ?> id="terms" />
			</p>
			<?php endif; ?>
			...
			echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="green button left" name="woocommerce_checkout_place_order" id="place_order" value="' . $order_button_text . '" />' );
			?>

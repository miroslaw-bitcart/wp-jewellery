...
<div class="new-panel max full-width main">
	<a class="inverse" href="<?php echo esc_url( home_url( '/collection/christmas-gifts' ) ); ?>">
		<div class="caption">
			<h1>Let It Glow</h1>
			<h3 class="action hvr-grow inverse">Shop Christmas Gifts</h3>
			<h4>
...
<div class="tri-panel">
	<div class="new-panel short quarter">
	...
	<div class="new-panel short quarter">
		<a class="hot-100 inverse" href="<?php echo esc_url( home_url( '/trending/' ) ); ?>">
			...
			<h3 class="action inverse hvr-grow">Our Most Desired Items</h3>
		</a>
	</div>
	...
	<div class="new-panel short quarter">
		<a class="lookbooks inverse" href="<?php echo esc_url( home_url( '/lookbooks/' ) ); ?>">
			...
			<h3 class="action inverse hvr-grow">View Our Lookbooks</h3>
		</a>
	</div>
</div>
...
<div class="new-panel full-width reviews clearfix border-top border-bottom">

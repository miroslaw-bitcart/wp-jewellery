<div class="filter-container"> <!-- data-spy="affix" data-offset-top="500" */ -->
	<div class="filter-controls clearfix">
		<div class="search-results left" data-bind="visible: foundProducts() > 0">
			<span data-bind="html: $root.foundProductsString()"></span>
		</div>

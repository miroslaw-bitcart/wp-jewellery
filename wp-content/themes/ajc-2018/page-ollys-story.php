<?php get_header(); ?>
	...
	<div class="content ollys-story static">
		...
		<img class="full-width no-border" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/static-pages//ollys-story/ollys-story.jpg" alt="Olly Gerrish"/>

		<h2>Olly's Story</h2>

		<h3 class="space-below">It has been a long journey, with many twists and turns, but here I am, 40 years down the line, still loving working with antique jewellery and discovering new things every day. So let's go back right to the beginning...</h3>

		<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/static-pages/ollys-story/olly-1.jpg" alt="Olly Gerrish"/>
		...
		<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/static-pages/ollys-story/olly-2.jpg" alt="Olly Gerrish"/>
		...
		<img class="no-border" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/static-pages/ollys-story/olly-4.jpg" alt="Olly Gerrish"/>
		...
		<img class="full-width no-border" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/static-pages/ollys-story/olly-3.jpg" alt="Olly Gerrish"/>
		...
		<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/static-pages/ollys-story/olly-5.jpg" alt="Olly Gerrish"/>
		...
		<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/static-pages/ollys-story/olly-6.jpg" alt="Olly Gerrish"/>
		...
		<h3 class="space-below">So here we are today &ndash; 30 years later.</h3>

		<p>A lot has happened since those early days under the Westway. In 2008 my son Matt built a simple website and started listing some of my items online. Little did we know that over the next several years The Antique Jewellery Company would grow to become one of the world's leading online destinations for antique jewellery.</p>
		...
		<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/static-pages/ollys-story/olly-7.jpg" alt="Olly Gerrish"/>

		<p>It has been an exhilarating journey, of highs and lows, and I can't wait to see what the next chapter has in store!</p>

		<img class="no-border centered autowidth" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/static-pages/ollys-story/signature.jpg" alt="Olly Gerrish"/>

		<small class="full-width clearfix centered">Olly Gerrish</small>

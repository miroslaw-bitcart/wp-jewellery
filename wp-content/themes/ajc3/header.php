...
<body>
	...
	<header class="clearfix">
        ...
        <a class="site-title centered" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
	...
	<?php if ( !is_page('checkout') ) { ?>
		<nav class="primary clearfix" id="nav">
			<?php wp_nav_menu( array( 'theme_location' => 'header_menu', 'walker' => new AJC_Walker ) ); ?>
		</nav>
	<?php } ?>

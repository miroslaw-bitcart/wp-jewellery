...
function woocommerce_gateway_paypal_pro_init() {
	...
	class WC_Gateway_PayPal_Pro extends WC_Payment_Gateway {
		...
		function __construct() {
			...
			$this->icon 				= 'https://www.antiquejewellerycompany.com/wp-content/themes/ajc3/assets/images/misc/cards.png';
			...
			<div class="two-thirds left">
				<fieldset>
					<p class="form-row form-row-first">
						<label for="paypal_pro_cart_number"><?php _e("Card number", 'wc_paypal_pro') ?> <span class="required">*</span></label>
					...
					<div class="clear"></div>
					<p class="form-row form-row-first">
						<label for="cc-expire-month"><?php _e("Expiry date", 'wc_paypal_pro') ?> <span class="required">*</span></label>
					...
					<p class="form-row form-row-last">
						<label for="paypal_pro_card_csc"><?php _e("Security code", 'wc_paypal_pro') ?> <span class="required">*</span></label>
						<input type="text" class="input-text" id="paypal_pro_card_csc" name="paypal_pro_card_csc" maxlength="4" />
						<span class="help paypal_pro_card_csc_description"></span>
					</p>
				</fieldset>
			</div>

			<div class="security third right padded">
				<h3><span class="icon-lock"></span>Security</h3>
				<p>Our card payments are processed independently via PayPal, one of the most secure payment platforms in the world.</p>
				<p>We use 3D Secure to add a further layer of protection.</p>
			</div>

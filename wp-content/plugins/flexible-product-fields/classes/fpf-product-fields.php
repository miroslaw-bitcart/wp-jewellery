...
class FPF_Product_Fields {
    ...
    public function calculate_price( $price, $price_type, WC_Product $product, $with_tax = true ) {
        if ( $price_type == 'percent' ) {
            $regular_price = $product->get_regular_price();
            $price = $regular_price * $price / 100;
        }
        if ( $with_tax ) {
    ...
    public function get_field_types() {
        $ret = array(
            ...
            'select' => array(
	            'value'                 => 'select',
	            'label'                 => __( 'Select', 'flexible-product-fields-pro' ),
	            'has_required'          => true,
	            'has_options'           => true,
	            'has_price'             => false,
            ...
            'radio' => array(
	            'value'                 => 'radio',
	            'label'                 => __( 'Radio', 'flexible-product-fields-pro' ),
	            'has_required'          => true,
	            'has_options'           => true,
	            'has_price'             => false,
	            'price_not_available'   => false,
            ...
            'checkbox' => array(
	            'value'                 => 'checkbox',
	            'label'                 => __( 'Checkbox', 'flexible-product-fields-pro' ),
	            'has_required'          => true,
	            'has_options'           => false,
	            'has_price'             => true,
	            'price_not_available'   => false,
